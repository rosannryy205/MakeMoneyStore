<main class="main-contentad">
    <h2>Hủy đơn hàng</h2>
    <br>
    <form action="<?= _WEB_ROOT_ ?>/admin/delete_order" method="post">
        ...
        <input style="width: 400px; height: 50px; border-radius: 30px; padding-left: 20px" type="text" name="sale_percent" value="<?= $order['total_amount'] ?>" disabled>
        <br>
